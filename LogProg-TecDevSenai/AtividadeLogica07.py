...
# 2 - Implementar no meu a opção de ordenar por idade de forma crescente a lista de usuários. 
...
# Função para limpar (remover todos os usuários na pilha).
    def limpar_usuarios(self):
        self.__lista_usuarios.clear()
        print(f'Todos os usuários foram apagados.')
        self.__salvar_usuarios()
...
6. Para limpar (remover todos os usuários).
7. Para ordenar usuários por idade de forma crescente.
